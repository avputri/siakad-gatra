            ...
            <div class="row">
                <div class="col sm-6">
                    <div class="form-group">
                        <label>NIS</label>
                        <input name="NIS" value="<?= $siswa['NIS']?>" maxlenght="20" class="form-control" placeholder="NIS">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_kelas" class="form-control">
                            ...
                            <?php foreach ($kelas as $key => $value) { ?>
                               <option value="<?= $value['id_kelas']?>" <?= $siswa['id_kelas'] == $value['id_kelas'] ? 'selected' : '' ?>><?= $value['kelas']?></option>
                            <?php }?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="number" min="2021" name="tahun_angkatan"  
                            value="<?= $siswa['tahun_angkatan']?>"class="form-control" placeholder="2021">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
           ...
           <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="form-group">
                        ...
                        <img src="<?php echo base_url('public/fotosiswa/'. $siswa['foto_siswa'])?>" id="gambar_load" width="150px">
                    </div>
                </div>
           </div>
